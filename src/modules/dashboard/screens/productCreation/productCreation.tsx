    ...
    <div className="cc">
      ...
      <div className="cc__content">
        <div className="cc__content--form">
          ...
          <form onSubmit={ handleSubmit(submitForm, () => submitForm) }>
            <div className="">
              <TabGroup
            ...
            <div className="panels">
              { activeTabIndex === 0 && (
                <section className={ `panel__${ activeTabIndex === 0 ? "active" : "inactive" }` }>
                  { productPictures && <img src={ displayPicture } /> }
                  <InputFile
            ...
            <div className="dFlex">
              ...
              <div className="f1">
                ...
                { activeTabIndex === 1 && (
                  <Button visibleType={ EBtnVisibleType.solid } large={ ELarge.full } type={ 'submit' }>Create</Button>
                ) }
              </div>
            </div>
          </form>
